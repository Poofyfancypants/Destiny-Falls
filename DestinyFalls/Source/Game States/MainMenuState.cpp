...
void MainMenuState::Render()
{
	...
	pFonts->Render("Bernardo", Game::GetInstance()->GetString(1).c_str(), { PlayGame.left, PlayGame.top }, 1, { 255, 225, 255, 255 });
	pFonts->Render( "Bernardo" , Game::GetInstance()->GetString( 2 ).c_str() , { LoadGame.left , LoadGame.top } , 1 , { 255 , 225 , 255 , 255 } );
	pFonts->Render( "Bernardo" , Game::GetInstance()->GetString( 3 ).c_str() , { Options.left , Options.top } , 1 , { 255 , 225 , 255 , 255 } );
	pFonts->Render( "Bernardo" , Game::GetInstance()->GetString( 4 ).c_str() , { HowToPlay.left , HowToPlay.top } , 1 , { 255 , 225 , 255 , 255 } );
	pFonts->Render( "Bernardo" , Game::GetInstance()->GetString( 5 ).c_str() , { Credit.left , Credit.top } , 1 , { 255 , 225 , 255 , 255 } );
	pFonts->Render( "Bernardo" , Game::GetInstance()->GetString( 6 ).c_str() , { ExitGame.left , ExitGame.top } , 1 , { 255 , 225 , 255 , 255 } );
