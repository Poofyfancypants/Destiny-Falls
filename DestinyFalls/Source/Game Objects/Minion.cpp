...
void Minion::Render(int _posIndex)
{
	...
	case 0: //Top
		...
		pFont->Render("Bernardo", Game::GetInstance()->GetString(1, TypeString).c_str(), SGD::Point(450, ((float)(420 + (50 * _posIndex)))), 1, { 255, 225, 255, 255 });
	...
	case 1: //Middle
		...
		pGraphics->DrawString(L"Minion", SGD::Point(450, ((float)(420 + (50 * _posIndex)))));
